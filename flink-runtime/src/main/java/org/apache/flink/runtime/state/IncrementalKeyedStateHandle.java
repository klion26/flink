...
public interface IncrementalKeyedStateHandle extends KeyedStateHandle {
	...
	/** Returns the map of (ids -> statehandle) of all registered shared states in the backend at the time this was created. */
	@Nonnull
	Map<StateHandleID, StreamStateHandle> getSharedStates();
}
