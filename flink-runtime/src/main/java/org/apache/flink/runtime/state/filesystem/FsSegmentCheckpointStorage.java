...
import static org.apache.flink.runtime.state.filesystem.FsCheckpointStreamFactory.DEFAULT_WRITE_BUFFER_SIZE;
...
public class FsSegmentCheckpointStorage extends AbstractFsCheckpointStorage {
	...
	public FsSegmentCheckpointStorage(
		...
		this(checkpointBaseDirectory.getFileSystem(), checkpointBaseDirectory, defaultSavepointDirectory, jobId, fileSizeThreshold);
	}
