...
public class JavaSerializerUpgradeTest extends TypeSerializerUpgradeTestBase<Serializable, Serializable> {
	...
	public static final class JavaSerializerSetup implements TypeSerializerUpgradeTestBase.PreUpgradeSetup<Serializable> {
		...
		public Serializable createTestData() {
			return new TestSerializableClass("flink", 10);
		}
	}
	...
	public static final class JavaSerializerVerifier implements TypeSerializerUpgradeTestBase.UpgradeVerifier<Serializable> {
		...
		public Matcher<Serializable> testDataMatcher() {
			return is(new TestSerializableClass("flink", 10));
		}
	...
	/**
	 * A class of {@link Serializable} used for test.
	 */
	public static final class TestSerializableClass implements Serializable {
		private String name;
		private int version;

		TestSerializableClass(String name, int version) {
			this.name = name;
		...
		public boolean equals(Object obj) {
			...
			if (!(obj instanceof TestSerializableClass)) {
				return false;
			}

			TestSerializableClass other = (TestSerializableClass) obj;
			return Objects.equals(other.name, name) && Objects.equals(other.version, version);
		}
	}
}
