...
object TraversableSerializerUpgradeTest {
  ...
  final class SeqSerializerVerifier extends
    ...
    override def schemaCompatibilityMatcher: Matcher[TypeSerializerSchemaCompatibility[Seq[Int]]] =
  ...
  final class SetSerializerVerifier extends
    ...
    override def schemaCompatibilityMatcher: Matcher[TypeSerializerSchemaCompatibility[Set[Int]]] =
