...
public class AvroSerializerUpgradeTest extends TypeSerializerUpgradeTestBase<Object, Object> {
	...
	public static final class GenericAvroSerializerSetup implements TypeSerializerUpgradeTestBase.PreUpgradeSetup<Address> {

		@Override
		public TypeSerializer<Address> createPriorSerializer() {
			@SuppressWarnings({"unchecked", "rawtypes"})
			AvroSerializer<Address> avroSerializer = new AvroSerializer(
					GenericRecord.class,
	...
	public static final class GenericAvroSerializerVerifier implements TypeSerializerUpgradeTestBase.UpgradeVerifier<GenericData.Record> {

		@SuppressWarnings({"unchecked", "rawtypes"})
		@Override
		public TypeSerializer<GenericData.Record> createUpgradedSerializer() {
		...
		@Override
		public GenericData.Record expectedTestData() {
		...
		@Override
		public Matcher<TypeSerializerSchemaCompatibility<GenericData.Record>> schemaCompatibilityMatcher() {
	...
	public static final class SpecificAvroSerializerVerifier implements TypeSerializerUpgradeTestBase.UpgradeVerifier<Address> {
		...
		@Override
		public Address expectedTestData() {
			Address addr = new Address();
			addr.setNum(239);
			addr.setStreet("Baker Street");
			addr.setCity("London");
